        ...
        <div id="kt_header" className="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
            ...
            <div className="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                ...
                <div className="d-flex d-lg-none align-items-center ms-n2 me-2">
                    ...
                    <div className="btn btn-icon btn-active-icon-primary" id="kt_aside_toggle" onClick={ toggleDrawer }>
                    ...
                    {/* begin::Logo*/}
                    <a href="../dist/index.html" className="d-flex align-items-center">
                        <img alt="Logo" src="/assets/media/logos/logo-default.svg" className="h-40px" />
                    </a>
                    {/* end::Logo*/}
                </div>
                {/* end::Wrapper */}
