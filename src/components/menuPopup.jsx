...
export default function MenuPopup({ popup, callback }) {
        ...
        <div className={`menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px ${popup}`} data-kt-menu="true" style={{zIndex: "111", position: "absolute", inset: "auto auto 0px 0px", margin: "0px", transform: "translate3d(15px, -70px, 0px)"}} data-popper-placement="top-start">
            ...
            <div className="menu-item px-3">
                ...
                <div className="symbol symbol-50px me-5">
                    <Image src="/assets/media/avatars/150-26.jpg" height={ 48 } width={ 48 } alt="user" />
                </div>
                {/* end::Avatar */}
                {/* begin::Username */}
            ...
            {/* end::Menu separator */}
            {/* begin::Menu item */}
            <div className="menu-item px-5" onClick={ handlePopup }>
            ...
            <div className="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
                <div onClick={ handlePopup }>
                    <Link href="/admin/my-subsciption">
                        <a className="menu-link px-5">
                ...
                <div className="menu-sub menu-sub-dropdown w-175px py-4">
                    {/* begin::Menu item */}
                    <div className="menu-item px-3" onClick={ handlePopup }>
                        <Link href="/admin/referrals">
                            <a className="menu-link px-5">Referrals</a>
                        </Link>
                    </div>
                    {/* end::Menu item */}
                    {/* begin::Menu item */}
                    <div className="menu-item px-3" onClick={ handlePopup }>
                        <Link href="/admin/billing">
                            <a className="menu-link px-5">Billing</a>
                        </Link>
                    </div>
                    {/* end::Menu item */}
                    {/* begin::Menu item */}
                    <div className="menu-item px-3" onClick={ handlePopup }>
                        <Link href="/admin/payments">
                            <a className="menu-link px-5">Payments</a>
                        </Link>
                    </div>
                    {/* end::Menu item */}
                    {/* begin::Menu item */}
                    <div className="menu-item px-3" onClick={ handlePopup }>
                        <Link href="/admin/statements">
                            <a className="menu-link d-flex flex-stack px-5">Statements
                                <i className="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="View your statements" aria-label="View your statements"></i>
                            </a>
                        </Link>
                    </div>
                    {/* end::Menu item */}
            ...
            {/* end::Menu separator */}
            {/* begin::Menu item */}
            <div className="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end" onClick={ handlePopup }>
                    ...
                    <a className="menu-link px-5">
                        <span className="menu-title position-relative">Language
                            <span className="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">English
                                <Image className="w-15px h-15px rounded-1 ms-2" src="/assets/media/flags/united-states.svg" height={ 48 } width={ 48 } alt="language" />
                            </span>
                        </span>
                    </a>
                </Link>
