            ...
            <div className="card card-xl-stretch mb-5 mb-xl-8">
              ...
              <div className="card-header border-0 pt-5">
                ...
                <div className="card-toolbar" data-kt-buttons="true">
                  <select className="form-select form-select-sm form-select-solid w-125px" data-control="select2" data-hide-search="true" data-placeholder="Status">
                    <option></option>
              ...
              {/* end::Header */}
              {/* begin::Body */}
              <div className="card-body d-flex align-items-end pb-0 px-5">
                {/* begin::Chart */}
                <div id="kt_charts_widget_1_chart" className="w-100" style={{height: "350px"}}></div>
                {/* end::Chart */}
              </div>
              {/* end::Body */}
            </div>
            ...
            <div className="card card-xl-stretch mb-5 mb-xl-8">
              ...
              <div className="card-body pt-5">
                ...
                <div className="d-flex align-items-sm-center">
                  ...
                  <div className="d-flex align-items-center flex-row-fluid flex-wrap">
                    <div className="flex-grow-1 me-2">
                      <a href="#" className="text-gray-800 text-hover-primary fs-6 fw-bolder">Fox Broker App</a>
                      <span className="text-muted fw-bold d-block fs-7">Finance, Corporate, Apps</span>
                    </div>
                    <span className="badge badge-light fw-bolder my-2">+145$</span>
                  </div>
                  {/* end::Section */}
                </div>
                {/* end::Item */}
        ...
        <div className="g-5 gx-xxl-8">
          ...
          <div className="card card-xxl-stretch">
            ...
            <div className="card-header">
              ...
              <div className="card-toolbar">
                <a href="#" className="btn btn-primary">Manage Calendar</a>
              </div>
            </div>
            {/* end::Card header */}
            {/* begin::Card body */}
