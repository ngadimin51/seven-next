					...
					<div className="d-flex flex-wrap flex-sm-nowrap mb-3">
						...
						<div className="me-7 mb-4">
							<div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative" style={{borderRadius: '5px', overflow: 'hidden'}}>
								<Image src="/favicon.png" alt="image" height={ 160 } width={ 160 } />
							...
							<div className="d-flex justify-content-between align-items-start flex-wrap mb-2">
								...
								<div className="d-flex flex-column">
									...
									<div className="d-flex align-items-center mb-2">
										<a href="https://github.com/ngadimin51" target='_blank' rel='noopener noreferrer' className="text-gray-800 text-hover-primary fs-2 fw-bolder me-1">Ngadimin</a>
										<a href="#">
									...
									<div className="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
										...
										<a href="mailto:info@ndalu.id" className="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
				...
				<div className="card-body p-9">
					...
					<div className="row mb-7">
						...
						<div className="col-lg-8">
							<span className="fw-bolder fs-6 text-gray-800">Ngadimin 51</span>
						</div>
						{/* end::Col */}
					</div>
					{/* end::Row */}
					...
					<div className="row mb-7">
						...
						<div className="col-lg-8 fv-row">
							<span className="fw-bold fs-6 text-gray-800">ndalu.id || caket.org</span>
						</div>
						{/* end::Col */}
					</div>
					{/* end::Input group */}
					...
					<div className="row mb-7">
						...
						<div className="col-lg-8 d-flex align-items-center">
							<span className="fw-bolder fs-6 me-2 text-gray-800">number not published</span>
					...
					<div className="row mb-7">
						...
						{/* begin::Col */}
						<div className="col-lg-8">
							<a href="https://ndalu.id" target='_blank' rel='noopener noreferrer' className="fw-bold fs-6 text-gray-800 text-hover-primary">ndalu.id</a>
						</div>
						{/* end::Col */}
					</div>
					{/* end::Input group */}
					...
					<div className="row mb-7">
						...
						{/* begin::Col */}
						<div className="col-lg-8">
							<span className="fw-bolder fs-6 text-gray-800">Indonesia</span>
						</div>
						{/* end::Col */}
					</div>
					{/* end::Input group */}
					...
					<div className="row mb-7">
						...
						{/* begin::Col */}
						<div className="col-lg-8">
							<span className="fw-bolder fs-6 text-gray-800">Email, Whatsapp, Telegram</span>
						</div>
						{/* end::Col */}
					</div>
					{/* end::Input group */}
